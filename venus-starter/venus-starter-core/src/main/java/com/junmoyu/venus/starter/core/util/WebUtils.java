...
public class WebUtils extends org.springframework.web.util.WebUtils {
    ...
    /**
     * 判断是否 ajax 请求 spring ajax 返回含有 ResponseBody 或者 RestController注解
     *
    ...
    public String extractClientId(String header, final String defVal) {
        ...
        if (header == null || !header.startsWith(BASIC_)) {
            log.debug("请求头中 client 信息为空: {}", header);
            return defVal;
        }
    ...
    public String getClientId(String header) {
        ...
        if (clientId == null) {
            throw new VenusException("Invalid basic authentication token");
        }
        return clientId;
    }
}
